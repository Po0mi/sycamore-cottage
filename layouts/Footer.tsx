...
const NAV_COLS: NavCol[] = [
  ...
  },
  {
    ...
    links: [
      {
        label: "enquiries@sycamorecottageresthome.com",
        href: "mailto:enquiries@sycamorecottageresthome.com",
      },
...
const SOCIAL: Social[] = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/sycamore_cottage_home/",
    icon: (
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/sycamorecottageresthome",
    icon: (
      <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
